...
const PaginationControls = ({ currentPage, totalPages, firstPage, prevPage, nextPage, lastPage, paginate }) => {
  return (
    <div className="bg-white px-4 py-3 border-t border-gray-200 overflow-x-auto min-w-0">
      ...
      <div className="hidden sm:flex items-center justify-between">
        <nav className="inline-flex flex-nowrap rounded-md shadow-sm gap-px" aria-label="Pagination">
          <button
            onClick={firstPage}
            disabled={currentPage === 1}
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 border border-gray-300 text-sm ${
                    currentPage === number + 1 ? "bg-blue-100 text-blue-600 font-semibold" : "bg-white text-gray-600 hover:bg-gray-100"
                  }`}
                >
                  {number + 1}
                </button>
